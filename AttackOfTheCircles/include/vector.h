...
/**
 * Projects a vector v1 onto another vector v2
 * In other words, the function returns the component of
 * v1 which is in the same direction as v2
 *
 * @param v1 the vector to be projected
 * @param v2 the axis where we must find a projection on
 * @return v the component vector of v1 in the direction of v2 
 */
